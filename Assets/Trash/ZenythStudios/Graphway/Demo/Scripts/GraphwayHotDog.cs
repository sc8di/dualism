...
public class GraphwayHotDog : MonoBehaviour 
{
	...
	void Update()
	{
		...
		graphway.PathFind(transform.position, targets[Random.Range(0,targets.Length-1)].position, FindPathCallback, true, debugMode);
